...
* **Generating Boilerplate Code**: Creating shell scripts, build system rules, kernel config fragments, or standard helper utilities.
* **Automating Repetitive Tasks**: Writing documentation, formatting tables, and converting data structures.
* **Rapid Research & Reference**: Troubleshooting build issues, looking up Linux kernel APIs, ARM architecture specifics, and avoiding long searches on Stack Overflow.
...
* **No Blind Copy-Pasting**: Never submit code that you do not understand or cannot debug yourself. This is especially important for kernel patches and baremetal loader code where bugs can brick devices.
...
> **TL;DR**: Use AI to work faster, write boilerplate, and learn APIs — but **always review every line**, **test your changes on real hardware**, and **take full personal ownership** of your PRs.
